...
export const VenueSection: React.FC = () => {
  ...
  const venueSlides = [
    {
      title: 'El Jardín & Espacio de Ceremonia',
    ...
    {
      title: 'Salón de Eventos El Paraíso',
    ...
    {
      title: 'Terraza & Área de Cóctel',
      subtitle: 'Espacio de bienvenida para el brindis al atardecer y barra de tragos de autor.',
      icon: '🥂',
      tag: 'CÓCTEL',
  ...
  const handleOpenGoogleMaps = () => {
    window.open('https://maps.google.com/?q=28.6692,77.4538', '_blank');
  };
      ...
      <div className="max-w-[1280px] mx-auto">
        ...
        <div className="text-center mb-14">
          ...
          <p className="text-[#1D373C] text-sm sm:text-base max-w-2xl mx-auto font-sans">
            Descubre el lugar donde celebraremos la unión de Shweta y Abhinav. Aquí encontrarás fotos del recinto, un mapa interactivo y datos de acceso.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-6 flex flex-col justify-between">
            <div className="w-full h-[480px] sm:h-[560px] rounded-2xl bg-[#183B42] border border-[#0B272D]/20 shadow-xl overflow-hidden relative flex flex-col justify-between p-8 text-white">
              ...
              <div className="flex items-center justify-between z-10">
                <span className="bg-[#D6E4BA] text-[#0B272D] text-[10px] font-bold tracking-widest uppercase px-3.5 py-1.5 rounded-full shadow-sm font-sans">
                  {venueSlides[activePhoto].tag}
                </span>
                <span className="text-2xl">{venueSlides[activePhoto].icon}</span>
              </div>
              ...
              <div className="my-auto text-center z-10 py-6">
                <div className="w-24 h-24 mx-auto rounded-full bg-white/10 border border-white/20 flex items-center justify-center text-5xl mb-4 shadow-inner">
                  {venueSlides[activePhoto].icon}
                </div>
                <h3 className="font-serif-display text-3xl sm:text-4xl font-bold text-white mb-2 leading-tight">
                  {venueSlides[activePhoto].title}
                </h3>
                <p className="text-xs sm:text-sm text-[#E0E8E5]/90 max-w-md mx-auto leading-relaxed font-sans">
                  {venueSlides[activePhoto].subtitle}
                </p>
              </div>
                ...
                <div className="flex items-center gap-3">
                  <button
                    ...
                    className={`rounded-full transition-all ${
                      activePhoto === 0 ? 'w-7 h-3 bg-[#BBDB93] border border-[#0B272D]' : 'w-3 h-3 bg-[#0B272D]/30'
                    }`}
                    aria-label="Foto 1"
                  />
                  <button
                    ...
                    className={`rounded-full transition-all ${
                      activePhoto === 1 ? 'w-7 h-3 bg-[#BBDB93] border border-[#0B272D]' : 'w-3 h-3 bg-[#0B272D]/30'
                    }`}
                    aria-label="Foto 2"
                  />
                  <button
                    ...
                    className={`rounded-full transition-all ${
                      activePhoto === 2 ? 'w-7 h-3 bg-[#BBDB93] border border-[#0B272D]' : 'w-3 h-3 bg-[#0B272D]/30'
                    }`}
                    aria-label="Foto 3"
                  />
                </div>
          ...
          <div className="lg:col-span-6 flex flex-col space-y-4">
            ...
            <div className="w-full h-[300px] sm:h-[340px] rounded-xl bg-[#E0E8E5] border border-[#0B272D]/20 overflow-hidden relative shadow-md flex items-center justify-center">
              <iframe
                ...
                src="https://maps.google.com/maps?q=28.6692,77.4538&hl=es&z=14&output=embed"
            ...
            <div className="w-full h-12 rounded-full bg-[#0B272D] px-6 flex items-center text-white text-xs font-semibold tracking-wide shadow-md font-sans">
              <span className="truncate">⏱️ ~45 min desde el centro / aeropuerto</span>
            </div>

            {/* 3. Chips Row (Ceremonia, Recepción, Parking) */}
            ...
            <div className="w-full rounded-xl bg-white border border-[#0B272D]/15 p-5 sm:p-6 shadow-md font-sans space-y-2">
              <h3 className="font-serif-display text-xl font-semibold text-[#0B272D]">
                Estancia / Salón de Eventos El Paraíso
              </h3>
              <p className="text-xs text-[#1D373C]">
                <strong>Dirección:</strong> Av. del Jardín 123, Ghaziabad, India
              </p>
              <p className="text-xs text-[#1D373C]">
                <strong>Coordenadas GPS:</strong> 28.6692° N, 77.4538° E
              </p>
              <p className="text-xs text-[#1D373C]">
                <strong>Parking:</strong> Valet disponible, +10 lugares de estacionamiento propio.
              </p>
            </div>
